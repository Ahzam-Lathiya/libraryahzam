...
from django.contrib.auth.models import User, Permission # Required to assign User as borrower
...
class LoanedBookInstancesByUserListViewTest(TestCase):
    def setUp(self):
        ...
        test_author = Author.objects.create(first_name = 'John',
                                            last_name = 'Smith')
        test_genre = Genre.objects.create(name = 'Mystery')
        ...
        genre_objects_for_book = Genre.objects.all()
        test_book.genre.set(genre_objects_for_book) # Direct assignment of many-to-many no allowed
        test_book.save()
...
class AuthorCreateTest(TestCase):
    ...
    def test_redirects_to_detail_view_on_success(self):
        ...
        #Manually check redirect because don't know what author was created
        self.assertEqual(response.status_code, 302)
